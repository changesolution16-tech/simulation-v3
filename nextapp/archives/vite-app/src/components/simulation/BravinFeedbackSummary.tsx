...
import { CompetencyFeedback as CompetencyFeedbackType, SimulationFeedbackSummary } from '../../lib/competencyFeedback';
...
const CompetencyFeedbackCard: React.FC<{ competency: CompetencyFeedbackType }> = ({ competency }) => {
