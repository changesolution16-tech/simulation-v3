...
import { Sparkles, CheckCircle, AlertCircle, Target, TrendingUp, Info, ChevronDown, ChevronUp } from 'lucide-react';
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">
                  Based on your selected metrics, we recommend {competencySuggestions.length} competenc{competencySuggestions.length === 1 ? 'y' : 'ies'}
                </p>
              </div>
            </div>
            <div className="flex items-center gap-3">
            ...
            <div className="px-4 pb-4 space-y-3">
                      ...
                      <div className="flex-1">
                        <div className="flex items-start justify-between mb-1">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className={`text-xs px-2 py-0.5 rounded border ${getConfidenceBadgeColor(suggestion.confidence)}`}>
                              {suggestion.confidence}
                            </span>
                          </div>
                        </div>
                        <p className="text-xs text-gray-600 mb-2">{suggestion.competency_description}</p>
              ...
              {onAcceptSuggestions && (
                <div className="flex gap-2 pt-3 border-t border-blue-200">
                  ...
                  >
                    Accept {selectedSuggestions.size} Selected Competenc{selectedSuggestions.size === 1 ? 'y' : 'ies'}
                  </button>
                  {onRejectSuggestions && (
                    <button
        ...
        <div className="border border-green-200 rounded-lg bg-gradient-to-r from-green-50 to-emerald-50">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">
                  {mappingPreviews.length} mapping{mappingPreviews.length === 1 ? '' : 's'} will be created automatically
                </p>
              </div>
            </div>
          ...
          {expandedSections.has('mappings') && (
            <div className="px-4 pb-4 space-y-2 max-h-96 overflow-y-auto">
              {mappingPreviews.map((mapping, index) => (
                <div
                  ...
                  <div className="flex items-start justify-between mb-2">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className={`text-xs px-2 py-0.5 rounded border ${getConfidenceBadgeColor(mapping.confidence)}`}>
                          {mapping.confidence}
                        </span>
                      </div>
                    </div>
