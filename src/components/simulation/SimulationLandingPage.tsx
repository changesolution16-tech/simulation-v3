...
import { ArrowLeft, CheckCircle2, Clock, Target, PlayCircle } from 'lucide-react';
import { useLanguage } from '@/contexts/LanguageContext';
import VideoPlayer from '@/components/simulation/VideoPlayer';

interface SimulationLandingPageProps {
  simulationId: string;
  onStart: () => void;
}

const SimulationLandingPage: React.FC<SimulationLandingPageProps> = ({
  simulationId,
  onStart
}) => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center">
        <div className="text-center">
          <p className="text-gray-600 dark:text-gray-400">Simulation not found</p>
          <button
            onClick={() => router.push('/dashboard')}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        >
            ...
            <div className="p-4 lg:p-6">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h1 className="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-gray-100 mb-3 leading-tight">
                  {getTranslatedField(simulation, 'landing_title') || getTranslatedField(simulation, 'display_name')}
                </h1>

                <p className="text-base text-gray-700 dark:text-gray-300 leading-relaxed max-w-4xl">
                  {getTranslatedField(simulation, 'landing_description') || getTranslatedField(simulation, 'description')}
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="p-4">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">{t('simulation.landing.introductionVideoDesc')}</p>
                  </div>
                </div>
                <VideoPlayer
          ...
          <div className="grid lg:grid-cols-2 gap-4">
            ...
            {getTranslatedField(simulation, 'landing_role_description') && (
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 border border-gray-100 dark:border-gray-700">
                <div className="flex items-center gap-2 mb-3">
